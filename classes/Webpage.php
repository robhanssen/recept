...
class Webpage
{
    ...
    function Footer()
    {
          ...
          echo "<div style=\"text-align : right\"><h5>Currently there $comment on this site<br>";
          echo "For suggestions and comments please contact the <a href=\"/recept/mail.php?to=web&subject=Your+website\">webmaster</a><br>" . date("l \\t\h\e jS \o\f F\, Y, H:i:s");
